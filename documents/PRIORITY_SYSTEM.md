...
- Create PriorityCalculatorService
- Add priority config
- Integrate with TicketClassifierService

### Phase 4: SLA Calculation
- Create SlaCalculatorService
- Integrate SLA calculation in controllers
- Add priority recalculation on updates
...
New files:
- `app/Services/PriorityCalculatorService.php`
- `app/Services/SlaCalculatorService.php`
- `config/priority.php`
- `documents/PRIORITY_SYSTEM.md`
- `database/migrations/XXXX_add_priority_system_to_tickets_table.php`
- `resources/views/components/priority-badge.blade.php`
- `resources/views/components/sla-indicator.blade.php`

## Files to Modify

Existing files:
- `app/Services/TicketClassifierService.php`
